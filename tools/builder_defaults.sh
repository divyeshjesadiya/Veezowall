...
export PKG_REPO_SERVER_DEVEL=${PKG_REPO_SERVER_DEVEL:-"http://${STAGING_HOSTNAME}"}
export PKG_REPO_SERVER_RELEASE=${PKG_REPO_SERVER_RELEASE:-"http://${STAGING_HOSTNAME}"}
export PKG_REPO_SERVER_STAGING=${PKG_REPO_SERVER_STAGING:-"http://${STAGING_HOSTNAME}"}
