...
export PKG_RSYNC_DESTDIR=${PKG_RSYNC_DESTDIR:-"/usr/local/poudriere/data/packages"}
...
if [ -n "${_IS_RELEASE}" ]; then
	export PKG_FINAL_RSYNC_HOSTNAME=${PKG_FINAL_RSYNC_HOSTNAME:-"18.185.190.151"}
...
# pkg repo variables
export REPO_HOSTNAME=${REPO_HOSTNAME:-"packages.veezo.org"}
