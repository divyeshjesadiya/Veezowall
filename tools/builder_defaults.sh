...
STAGING_HOSTNAME=${STAGING_HOSTNAME:-"217.36.208.245"}
...
export PKG_REPO_SERVER_DEVEL=${PKG_REPO_SERVER_DEVEL:-"pkg+http://${STAGING_HOSTNAME}:8081"}
export PKG_REPO_SERVER_RELEASE=${PKG_REPO_SERVER_RELEASE:-"pkg+http://${STAGING_HOSTNAME}:8081"}
export PKG_REPO_SERVER_STAGING=${PKG_REPO_SERVER_STAGING:-"pkg+http://${STAGING_HOSTNAME}:8081"}
